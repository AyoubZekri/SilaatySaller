import 'dart:io';
import 'dart:math';
import 'package:Saller/core/functions/uploudfiler.dart';
import 'package:Saller/data/datasource/Remote/Prodact/Prodact_data.dart';
import 'package:Saller/data/model/Product_Model.dart' as Prodact;
...
class Edititemcontroller extends GetxController {
  ...
  void initData(Prodact.Data product) {
    ...
    barcodeController.text = (type == 2 && product.codepar != null && product.codepar.toString().length >= 5)
