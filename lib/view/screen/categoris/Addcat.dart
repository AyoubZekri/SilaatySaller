import 'package:Saller/controller/categoris/Addcatcontroller.dart';
                    ...
                    Custembutton(
                      ...
                      onPressed: () {
                        if (!validInputsnak(controler.nameController.text, 1,
                            20, "Name Categoris".tr)) {
                          return;
                        }
                        if (!validInputsnak(controler.nameFrController.text, 1,
                            20, "Name Categoris fr".tr)) {
                          return;
                        }
                        controller.addcat();
                      },
