import 'package:Saller/controller/Profaile/invoice/Shwoinvoicecontroller.dart';
import 'package:Saller/core/class/handlingview.dart';
import 'package:Saller/view/widget/Bills/CustemEditpayment.dart';
...
class _PaymentState extends State<Shwoinvoice> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<Shwoinvoicecontroller>(
        init: Shwoinvoicecontroller(),
        builder: (controller) {
          return Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Text('#${controller.invoices!.number}'.tr,
                    style: Theme.of(context).textTheme.headlineMedium!.copyWith(
                        color: AppColor.backgroundcolor, fontSize: 24)),
                backgroundColor: AppColor.white,
