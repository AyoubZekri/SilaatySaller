...
import 'package:Saller/core/functions/valiedinput.dart';
import 'package:Saller/view/widget/Auth/custembutonauth.dart';
import 'package:Saller/view/widget/Auth/login/CustemBody.dart';
import 'package:Saller/view/widget/Auth/login/Custemtextformauth.dart';
import 'package:Saller/view/widget/Auth/login/custemtitle.dart';
        ...
        body: Container(
            ...
            child: GetBuilder<Logincontroller>(
                builder: (_) => Container(
                      color: Colors.white,
                      padding:
                          const EdgeInsets.only(left: 35, right: 35, top: 100),
                      child: Form(
