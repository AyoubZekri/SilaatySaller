...
class Custemcartallinvoice extends StatefulWidget {
  final String Title;
  final String Status;
  final String Price;
  ...
  @override
  State<Custemcartallinvoice> createState() => _CustemcartallinvoiceState();
}
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(widget.nameclient, style: TextStyle(fontSize: 15)),
